    ...
    <div className=' container py-20'>
        <div className='w-[95%] mx-auto flex items-center gap-6 '>
          <div className="flex-1">
            ...
            <h2 className='text-6xl inline-block tracking-wide text-white drop-shadow-xl font-bold font-[monospace] my-4 relative after:absolute after:top-0 after:left-0 after:w-full after:h-[95%] after:content-[""] after:bg-green-600 after:-z-10 after:skew-y-1 after:skew-x-6'>Junior Aliy</h2>
            ...
            <ButtonCommon label={'CVni olish'} classHandler='text-green-600 mt-4 rounded-sm mx-2 border border-green-600' link={'about-me/get-cv'}/>
          </div>
