  ...
  return (
    <div className='w-[80%] flex items-center gap-6 py-16 mx-auto'>
        <div className="flex-1 with-48">
          ...
          <h2 className='text-7xl tracking-wide text-white drop-shadow-xl font-bold font-[monospace] my-4 relative after:absolute after:top-0 after:left-0 after:w-full after:h-[95%] after:content-[""] after:bg-green-600 after:-z-10 after:skew-y-1 after:skew-x-6'>Junior Aliy</h2>
